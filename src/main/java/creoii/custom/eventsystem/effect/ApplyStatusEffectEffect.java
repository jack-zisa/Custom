...
public class ApplyStatusEffectEffect extends Effect {
    ...
    private ValueProvider<Double> amplifier;
    ...
    public ApplyStatusEffectEffect withValues(StatusEffect statusEffect, ValueProvider<Double> amplifier, ValueProvider<Double> duration, boolean ambient, boolean showParticles, boolean showIcon, boolean affectTarget) {
    ...
    public Effect getFromJson(JsonObject object) {
        ...
        ValueProvider<Double> amplifier = (ValueProvider<Double>) ValueProvider.getFromJson(object, "amplifier");
    ...
    private void run(Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            livingEntity.addStatusEffect(new StatusEffectInstance(statusEffect, amplifier.getValue().intValue(), duration.getValue().intValue(), ambient, showParticles, showIcon));
        }
    }
