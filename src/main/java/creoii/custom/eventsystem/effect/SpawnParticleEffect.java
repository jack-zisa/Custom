...
public class SpawnParticleEffect extends AbstractEffect {
    ...
    public AbstractEffect getFromJson(JsonObject object) {
        ...
        if (object.has("entries")) {
            ...
            for (int i = 0; i < array.size(); ++i) {
                ...
                if (element.isJsonObject()) {
                    ...
                    entries[i] = new ParticleEntry(
                            (DefaultParticleType) Registries.PARTICLE_TYPE.get(Identifier.tryParse(JsonHelper.getString(elementObj, "particle"))),
            ...
            effect.particle = (DefaultParticleType) Registries.PARTICLE_TYPE.get(Identifier.tryParse(JsonHelper.getString(object, "particle")));
