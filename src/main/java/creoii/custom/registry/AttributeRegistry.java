...
public class AttributeRegistry {
    ...
    public static void register() {
        Registry.register(Registries.ATTRIBUTE, new Identifier(Custom.NAMESPACE, "generic.gravity"), GENERIC_GRAVITY);
        Registry.register(Registries.ATTRIBUTE, new Identifier(Custom.NAMESPACE, "generic.swim_speed"), GENERIC_SWIM_SPEED);
        Registry.register(Registries.ATTRIBUTE, new Identifier(Custom.NAMESPACE, "generic.jump_height"), GENERIC_JUMP_HEIGHT);
    }
}
